...
public final class ViajesObj {
    ...
    public ViajesObj (int pId, String pNombreCliente, String pNombreConductor, String pNombreLugar, int pDistancia, Date pDia, Time pHora, String pTotal, String pTarjetaCredito)
    {
       setId(pId);
